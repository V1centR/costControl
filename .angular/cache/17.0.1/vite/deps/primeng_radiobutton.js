...
function RadioButton_label_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction3(5, _c1, _r0.checked, ctx_r1.disabled, ctx_r1.focused));
    ɵɵattribute("for", ctx_r1.inputId);
    ɵɵadvance(1);
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function RadioButton_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵlistener("change", function RadioButton_Template_input_change_2_listener($event) {
        ...
        ɵɵlistener("click", function RadioButton_Template_div_click_4_listener($event) {
          ɵɵrestoreView(_r4);
          const _r0 = ɵɵreference(3);
        ...
        ɵɵelement(5, "span", 5);
        ɵɵelementEnd()();
        ɵɵtemplate(6, RadioButton_label_6_Template, 2, 9, "label", 6);
      }
      if (rf & 2) {
        ɵɵclassMap(ctx.styleClass);
        ɵɵproperty("ngStyle", ctx.style)("ngClass", ɵɵpureFunction3(15, _c2, ctx.checked, ctx.disabled, ctx.focused));
        ɵɵadvance(2);
        ɵɵproperty("checked", ctx.checked)("disabled", ctx.disabled);
        ɵɵattribute("id", ctx.inputId)("name", ctx.name)("value", ctx.value)("tabindex", ctx.tabindex)("aria-checked", ctx.checked)("aria-label", ctx.ariaLabel)("aria-labelledby", ctx.ariaLabelledBy);
        ɵɵadvance(2);
        ɵɵproperty("ngClass", ɵɵpureFunction3(19, _c3, ctx.checked, ctx.disabled, ctx.focused));
        ɵɵadvance(2);
